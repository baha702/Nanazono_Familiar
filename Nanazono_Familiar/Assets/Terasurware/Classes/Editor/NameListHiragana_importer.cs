...
public class NameListHiragana_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Resources/NameListHiragana.xlsx";
	private static readonly string exportPath = "Assets/Resources/NameListHiragana.asset";
	private static readonly string[] sheetNames = { "Hiragana", };
